            ...
            <div class="panel panel-success">
                ...
                <div class="container-fluid">
                    <div class="panel-body">
                        ...
                        <h5 class="pull-right">
                            مبلغ قابل پرداخت:
                            <span class="red-text"><?php echo number_format($details['price']*5000, 0);?></span>
                            <small class="red-text" style="margin-right: 10px;">تومان </small>
                        </h5>

                        <div class="input-field buttons col-md-3 pull-left bill-button">
                            <?php echo CHtml::tag('button', array('class'=>'btn waves-effect waves-light green lighten-1 col-md-12', 'id'=>'submit-form', 'type'=>'submit'), 'پرداخت');?>
                        </div>
                    </div>
                </div>
            </div>
