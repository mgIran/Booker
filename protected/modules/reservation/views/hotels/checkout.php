        ...
        <div id="checkout">
            <div class="card-panel">
                ...
                <div class="reserve-information cancel-rules">
                    <div class="overflow-fix">
                        <?php echo $this->getCancelRuleString($details['cancelRules'], $details['checkIn'], ($this->getFixedPrice($details['price']/10)['price']));?>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <h5 class="ltr blue-text text-darken-2 overflow-fix">
                                ...
                                <span class="pull-left"><?php echo number_format(($this->getFixedPrice($details['price']/10)['price']), 0);?></span>
                            </h5>
                        </div>
                    </div>
                </div>
