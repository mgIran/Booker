...
<head>
    ...
    <link rel="shortcut icon" href="<?= Yii::app()->createAbsoluteUrl('themes/frontend/images/favicon.ico'); ?>">
    <link rel="shortcut icon" href="<?= Yii::app()->createAbsoluteUrl('themes/frontend/images/favicon.svg'); ?>">
